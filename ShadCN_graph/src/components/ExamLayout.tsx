    ...
    <div id="start_div">
     <div className='overlay' id='overlay'>
        <div className='overlay-content'>
          <div className='overlay-elem'>
            <div className="overlay_div">
              <p>To begin the exam, click on the 'OK' button.</p><p>This action will automatically switch your browser to full-screen mode.</p><br></br><p>Please note that if you attempt to exit full-screen mode or switch tabs during the exam, you will receive a warning on your first attempt.</p><p>If you do so a second time, your exam will be terminated, and all your progress will be lost.</p>
           </div>
          </div>
          <div className='overlay-elem'>
      ...
      <div className="exam" id='tst_pnl'>    
        <div hidden className="exam_end" id="test_end_message">
        ...
        <div className="exam_content" id="exam_content">   
              ...
              <CardHeader className="exam_card_header">
